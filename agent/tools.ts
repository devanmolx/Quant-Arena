...
export const createPositionTool = tool(
    async ({ symbol, side, quantity, leverage, profitTarget, stopLoss, invalidationCondition }: { symbol: string; side: "LONG" | "SHORT"; quantity: number; leverage: number, profitTarget: number, stopLoss: number, invalidationCondition: string }) => {
